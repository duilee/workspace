...
class Chaser(Player):
    ...
    def __init__(self, name, base_energy, goals):
        ...
        """
        Player.__init__(self, name, base_energy)
        self.goals = goals
    ...
    def energy(self, time):
        ...
        if time % 9 != 0:
            ...
            return self.base_energy - (self.goals * Chaser.energy_expended) - (Chaser.energy_expended * 0.1)
...
class Keeper(Player):
    ...
    def energy(self, time):
        ...
        if time < 30:
            ...
            return self.base_energy - (Keeper.energy_expended * 0.8 * (time//15))
...
class Game:
    def __init__(self, players, your_name):
        ...
        self.villagers = [Villager(p) for p in players[2:]]
        self.name_to_player = {}
